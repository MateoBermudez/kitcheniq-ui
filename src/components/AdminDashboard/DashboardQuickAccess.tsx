    ...
    return (
        <svg width={160} height={160} viewBox="0 0 160 160">
            <g transform="translate(80,80)">
                ...
                />
                <text x="0" y="-5" textAnchor="middle" dominantBaseline="central" fontSize={20} fontWeight={700}>
                    ${target}
                </text>
...
const DashboardQuickAccess: React.FC<QuickAccessProps> = ({ alerts, onCloseAlert }) => {
    ...
    // Daily sales data (hardcoded for now - will come from backend later)
    const dailySales = 287; // Today's sales in dollars
